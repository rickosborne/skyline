...
templateRenderer.scan('adapter', (dir, name) => {
	templateRenderer.markdown(dir, name, (updatedBody, originalBody, dataType, dataName, templateId, templateDir, templateFileName) => {
		templateBlocks.push({
			updatedBody,
			originalBody,
			dataType,
