...
import {DND5EMachineDataTemplateBlock, DND5EMachineDataTemplateBlockType} from "../type/MachineTemplateBlock";
...
export class DND5EMachineRenderer extends Transformer<DND5EMachineDataTemplateBlock, RenderedTemplateBlock<DND5EMachineDataTemplateBlock>> {
	...
	constructor() {
		super(DND5EMachineDataTemplateBlockType, RenderedTemplateBlockType(DND5EMachineDataTemplateBlockType));
	}
